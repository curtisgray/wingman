...
//std::function<void(void *)> download_progress_handler;
//void signal_handler(void* pData)
//{
//	download_progress_handler(pData);
//}
...
// set timeouts and change hostname and port
	...
	std::thread webSocketServerThread(launch_websocket_server, std::ref(llama), sparams.hostname, sparams.websocket_port);
